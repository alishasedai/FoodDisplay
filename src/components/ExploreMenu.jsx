...
const ExploreMenu = ({category,setCategory}) => {
  ...
  return (
    <div className=' w-full h-70 gap-2 flex flex-col items-start justify-center'>
      ...
      <div className='w-full h-[30vh] md:h-[40vh] flex md:gap-10 gap-1 overflow-x-auto overflow-y-hidden  items-center  text-center'>
